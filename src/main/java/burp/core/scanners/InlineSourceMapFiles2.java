...
public class InlineSourceMapFiles2 implements Runnable{
    ...
    public InlineSourceMapFiles2(IHttpRequestResponse baseRequestResponse, UUID taskUUID, long timeStamp) {
